...
برای بیلد پروژه‌های جاوایی معمولا از ابزار‌هایی نظیر Apache Maven و یا Gradle استفاده می‌شود. خوشبختانه فندق از هر دو این Build Toolsها پشتیبانی می‌کند. 
