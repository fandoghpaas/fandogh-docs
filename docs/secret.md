...
---
Secretها(معادل فارسی مناسبی پیدا نکردیم هنوز) پیکربندی‌هایی هستند که حاوی اطلاعات محرمانه می‌باشند. Secretها در Namespace شما ذخیره شده و برای امور بخصوصی، بسته به نوع Secret، مورد استفاده قرار می‌گیرند.
## انواع Secret
