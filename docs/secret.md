...
Secretها پیکربندی‌هایی هستند که حاوی اطلاعات محرمانه می‌باشند. Secretها در Namespace شما ذخیره شده و برای امور مشخصی بسته به نوع Secret، مورد استفاده قرار می‌گیرند.
