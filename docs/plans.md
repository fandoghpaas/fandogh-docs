...
### رم (Memory)
هر سرویس می‌تواند میزان مشخصی رم در اختیار داشته باشد ولی این میزان نمی‌تواند از [Max Memory Per Service](https://docs.fandogh.cloud/docs/resources.html#max-memory-per-service) بیشتر شود.
