...
# دستور انتخاب و فعالسازی فضانام
...
# نمایش ۱۰۰ لاگ آخر سرویس با نام SERVICE_NAME و
ادامه نمایش لاگ سرویس به صورت realtime
...
# ساخت سکرت docker-registry با نام SECRET_NAME و فیلدهای مورد نیاز
fandogh secret create --name SECRET_NAME \
...
# ساخت سکرت environment-secret با نام SECRET_NAME و فیلدهای مورد نیاز
